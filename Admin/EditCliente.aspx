...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    ...
    <tr>
	  ...
	  <td height="20" colspan="3" valign="top"  >&nbsp; <h2> Alta de Clientes</h2></td>
    </tr>
    <tr>
          ...
          <table>
              ...
              <tr>
                  ...
                  <td>
                      ...
                      <ASP:RequiredFieldValidator id="rfvValidarNombre" runat="server" errormessage="Nombre Obligatorio" controltovalidate="txtNombre" display="Dynamic"></ASP:RequiredFieldValidator> <!--validador-->
                  </td>
              </tr>
              <tr>
                  <td>
